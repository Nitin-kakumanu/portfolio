...
>
  {[
    ...
    {
      image: "https://images.unsplash.com/photo-1649734926695-1b1664e98842?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      title: "Amazon Clone",
    ...
    <motion.div 
      key={index} 
      className="bg-gray-800 rounded-lg shadow-lg transform hover:scale-105 transition overflow-hidden border border-gray-700 hover:border-blue-500"
      initial={{ opacity: 0, y: 30 }}
      whileInView={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.6, ease: "easeOut" }}
      viewport={{ once: true }}
...
<section id="contact" className="py-20 flex flex-col items-center text-center px-8">
  ...
  <div className="flex flex-col min-h-screen">
      {/* Contact Section */}
      <div className="flex-grow flex flex-col items-center justify-center bg-gray-900 text-white py-16 px-6">
        ...
        <motion.form 
          ...
          className="bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-lg mt-8 space-y-4"
        ...
        >
          <input 
            ...
            required
            className="w-full p-3 rounded-md bg-gray-700 text-white focus:ring-2 focus:ring-green-400"
          />
          <input 
            type="email"
            name="email"
          ...
          <button 
            type="submit"
            className="w-full bg-green-500 p-3 rounded-md text-white font-semibold hover:bg-green-600 transition"
          >
            Send Message
          </button>
        </motion.form>
      ...
      <footer className="bg-gray-800 text-gray-300 py-4 text-center w-full">
        <p>© {new Date().getFullYear()} Nitin Kakumanu. All rights reserved.</p>
      </footer>
    </div>
</section>
